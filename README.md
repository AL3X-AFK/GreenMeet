...
El usuario deberá iniciar sesión o registrarse para poder acceder a la aplicación, puede logearse con Google.

 <img src="imgs/login.png" width="300"/>  <img src="imgs/register.png" width="300"/> 



### 3. **Descubrir Actividades**
...
| **Home** | **Mapa** | **Explorar** | **Inscritas** |
|:--------:|:------------:|:------------:|:------------:|
| <img src="imgs/home.png" width="250"/><br>Últimas actividades y categorías | <img src="imgs/explore_map.png" width="250"/><br>Buscar a través de mapa | <img src="imgs/explore.png" width="250"/><br>Buscar y filtrar actividades | <img src="imgs/inscrito.png" width="250"/><br>Actividades a las que te has inscrito |

### 4. **Interaccion con Actividades**
Conviértete en un organizador y crea, edita y organiza tus propios eventos. 
A través de un sencillo formulario, puedes especificar todos los detalles.
Ver quien se ha inscrito y a comentado en tu actividad.

<img src="imgs/createAct.png" width="300"/> <img src="imgs/editActivities.png" width="300"/> <img src="imgs/parAndCom.png" width="300"/> 
...
- **Notificaciones**: Recibe y controla las notificaciones relacionadas con las actividades.
...
- **Acerca de**: Informacion de los desarrolladores y de las imágenes utilizadas en el proyecto.  
...
- Toda la información se almacena en **Firebase** y **Supabase**, garantizando que:
